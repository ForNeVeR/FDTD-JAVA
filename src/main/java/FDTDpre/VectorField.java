...
public class VectorField {
	FDTDArray x = new FDTDArray();
	FDTDArray y = new FDTDArray();
	FDTDArray z = new FDTDArray();
	...
	public void copyGridtoSurf(int Nx, int Ny, int Nz) {
		x.copyGridtoSurf(Nx, Ny, Nz);
		y.copyGridtoSurf(Nx, Ny, Nz);
		z.copyGridtoSurf(Nx, Ny, Nz);
	}
}
